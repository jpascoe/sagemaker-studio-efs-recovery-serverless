...
if __name__ == "__main__":
    ...
    parser.add_argument("-domain-name", "--domain-name", dest="domain_name", type=str)
    ...
    parser.add_argument(
        "-replication", "--replication", dest="replication", action="store_true"
    )
    parser.add_argument(
        "-no-replication", "--no-replication", dest="replication", action="store_false"
    )
